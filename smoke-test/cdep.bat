...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CDEP_OPTS% "-Dio.cdep.appname=%APP_BASE_NAME%" "-Dhttps.protocols=TLSv1,TLSv1.1,TLSv1.2" -classpath "%CLASSPATH%" io.cdep.bootstrap.Bootstrap %MANIFEST% %CMD_LINE_ARGS%
