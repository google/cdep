...
public class TestCDepYmlUtils {
  ...
  public void testDuplicateGenerator() {
    ...
    try {
      ...
      assertThat(e).hasMessage("'builders' contains 'cmake' more than once");
    }
  }
  ...
  public void testNoBuilders() {
    ...
    try {
      ...
      assertThat(e).hasMessage("'builders' section is missing or empty. Valid values are: cmake cmakeExamples ndk-build ndk-build-examples.");
    }
  }
